...
{{--        <!-- <internet-connection position="e1:e6"></internet-connection> -->--}}
        <statistics position="e10:e27"></statistics>
        <statistics position="d10:d27"></statistics>
{{--        <uptime position="a1:a10"></uptime> --}}
{{--        <!-- <calendar position="e7:e16"></calendar> --}}
{{--        <!-- <velo position="e17:e24"></velo> --}}
        <team-member name="adriaan" avatar="{{ gravatar('adriaan@spatie.be') }}" birthday="1995-02-14" position="a1:a9"></team-member>
        <team-member name="ariel" avatar="{{ gravatar('adriaan@spatie.be') }}" birthday="1995-10-22" position="a10:a18"></team-member>
        <team-member name="rias" avatar="{{ gravatar('rias@spatie.be') }}" birthday="1992-05-25" position="a19:a27"></team-member>
